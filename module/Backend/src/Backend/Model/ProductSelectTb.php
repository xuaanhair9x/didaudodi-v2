...
class ProductSelectTb extends AbstractTableGateway
{
    ...
    public function listItem($params = null)
    {
        ...
        if (isset($params['list_product_cat_id'])) {
            $select->where->like('s.list_product_cat_id', '%:'.$params['list_product_cat_id'].':%');
        }
    ...
    public function saveData($params, $config = array())
    {
        ...
        if (isset($params['post']['list_product_cat_id'])) {
            $data['list_product_cat_id'] = ($params['post']['list_product_cat_id']) ? ':'.implode(':,:', $params['post']['list_product_cat_id']).':' : null;
        }
        foreach (array('multi_input','multi_detail','multi_image','multi_file') as $name) {
            if (isset($params['post'][$name])) {
