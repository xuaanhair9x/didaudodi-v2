    ...
    $.extend(Checklist.prototype, {
        renderList: function() {
            ...
            for(var i=0; i<this.sourceData.length; i++) {
                $label = $('<label class="mt-checkbox mt-checkbox-outline mt-checkbox-checklist">').append($('<input>', {
                                           type: 'checkbox',
                                           value: this.sourceData[i].value
                                     }))
                                     .append($('<span>')).append(' '+this.sourceData[i].text);
...
(function ($) {
    ...
    DateTimeField.defaults = $.extend({}, $.fn.editabletypes.datetime.defaults, {
        ...
        @property tpl
        **/
        tpl:'<div class="input-group input-group-fixed date"><input type="datetime-local" class="form-control input-medium pull-left"/><span class="input-group-btn pull-left"><button class="btn date-set default" type="button"><i class="fa fa-calendar"></i></button></span></div>',
         /**
        @property inputclass
        @default 'input-medium'
        **/
