...
$link_home = str_replace('template/backend/plugins/ckfinder/core/connector/php/connector.php', '', $_SERVER['PHP_SELF']); // return <tên thư mục web, vd "/frontend_dev/public_html/"
$baseUrl = $link_home.'uploads/';
